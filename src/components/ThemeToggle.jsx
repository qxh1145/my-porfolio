...
const ThemeToggle = () => {
  ...
  return (
    <div style={{ padding: 'none', gap:'10px', display: 'inline-block',position: 'absolute' ,transform: 'rotate(270deg)', fontSize : '15px', width: '197px', height: '10px'}} className="theme-toggle" role="group" aria-label="Theme selection">
